...
- Windows 下终端用 CMD；改 `src` 后同步更新 `D:\project\my_alex_brain` 对应 Ponytail 功能包文档
...
### Task 4: Docs + checklist + Ponytail

**Files:**
- Modify: `alex_miaosha_mobile/DEVELOPMENT.md`
- Modify: `alex_miaosha/tests/checklists/login-slim-menu-warmup.md`
- Sync: `D:\project\my_alex_brain`
...
- [x] **Step 3: Ponytail 知识库同步**

同步更新 `D:\project\my_alex_brain\02-Features\02-RBAC-用户组织权限\` 对应 TechSpec 与开发记录。
...
| 不改首页 | （无任务，刻意） |
| DEVELOPMENT + checklist + Ponytail | T4 |
| M1–M4 | T4 Step 4 |
